...
CREATE TABLE `Return` (
    ...
    UNIQUE INDEX `Return_orderItemId_key`(`orderItemId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Refund` (
    ...
    `refundProofImage` VARCHAR(191) NULL,
...
CREATE TABLE `Review` (
    ...
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `shopReply` LONGTEXT NULL,
    `shopRepliedAt` DATETIME(3) NULL,
    `shopRepliedBy` INTEGER NULL,
...
CREATE TABLE `MeasurementType` (
    ...
    UNIQUE INDEX `MeasurementType_name_key`(`name`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
