...
import { UpdateMeasurement } from "../types/MeasurementType";
...
const updateMeasurementById = async (req: Request, res: Response) => {
  try {
    ...
    const updateData: Partial<UpdateMeasurement> = {};
...
const getMeasurementById = async (req: Request, res: Response) => {
  try {
    ...
    const measurement = await measurementModel.getMeasurementById(id);
